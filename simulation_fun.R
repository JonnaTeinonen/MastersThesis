...
fun_parallel_robust <- function(x){
  ...
  response_models <- x[[5]]
  response_rate   <- x[[6]]
  file_name <- paste0("C:\\...\\Project\\simulation\\robust\\n", n,"\\RR", response_rate, "\\parallel_robust_results_i_", i, "_n_", n, "_RR_", response_rate, ".rds")
